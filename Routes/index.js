...
router.get("/api/v1/on-covid-19/xml", xmlResponse);
router.post("/api/v1/on-covid-19/xml", xmlResponse);
router.get("/api/v1/on-covid-19/logs", logResponse);
router.post("/api/v1/on-covid-19/logs", logResponse);
